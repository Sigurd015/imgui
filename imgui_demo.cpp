...
static void ShowDemoWindowWidgets()
{
    ...
    if (ImGui::TreeNode("Selectables"))
    {
        ...
        IMGUI_DEMO_MARKER("Widgets/Selectables/Multiple Selection (basic, manual)");
        if (ImGui::TreeNode("Selection State: Multiple Selection (basic, manual)"))
        {
        ...
        // Back to more basic examples using Selectable() without BeginMultiSelect() api
